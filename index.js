;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : (global['react-fontawesome'] = factory(global.PropTypes, global.React))
  ...
  var fontawesome = createCommonjsModule(function(module, exports) {
    /*!
 ...
 */
    ;(function(global, factory) {
      ...
      function transformForCss(_ref2) {
        ...
        if (startCentered && IS_IE) {
          ...
          val +=
            'translate(' + transform.x / d + 'em, ' + transform.y / d + 'em) '
        }
  ...
  var fontawesome$1 = unwrapExports(fontawesome)
  ...
  function FontAwesomeIcon$1(props) {
    ...
    var transform = objectWithKey(
      ...
      typeof props.transform === 'string'
        ? fontawesome$1.parse.transform(props.transform)
        : props.transform
    )
    var mask = objectWithKey('mask', normalizeIconArgs(maskArgs))

    var renderedIcon = fontawesome$1.icon(
      icon,
